  ...
  return <Section id="fechamento" background="white" style={{
    background: "linear-gradient(180deg, hsl(156 15% 42% / 0.08) 0%, hsl(0 0% 96%) 100%)"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
        {/* Opção 1 - Status Quo */}
        <div className="bg-grafite-suave/5 border-2 border-grafite-suave/20 rounded-xl p-8 opacity-70 animate-fade-in" style={{
        animationDelay: '0.1s'
      }}>
        ...
        {/* Opção 2 - Ação */}
        <div className="relative rounded-xl p-8 shadow-elevada animate-fade-in border-3 border-ocre-dourado" style={{
      ...
      {/* P.S. Triplo */}
      <div className="max-w-3xl mx-auto space-y-6 text-sm md:text-base text-grafite-suave/80 animate-fade-in" style={{
      animationDelay: '0.5s'
    }}>
        <p>
