...
const Problema = () => {
  ...
  return <Section id="problema" background="white">
      ...
      <div className="text-center max-w-3xl mx-auto animate-fade-in">
        <p className="text-grafite-suave mb-3 text-base">Resultado: sua mente nunca desliga. Seu corpo não relaxa. Você não sente calma de verdade.<span className="font-semibold text-rosa-argila">Resultado:</span> sua mente nunca desliga. Seu corpo não relaxa. Você não sente calma de verdade.
